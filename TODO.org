...
***** TODO 3.21.  Extended DNS Error Code 20 - Lame
      ...
      + Response: So, in the second case (expired), it should return
        an expired EDE...  I think what you're suggesting is "expired
        under validation" and "expired under authoritative".  I'd love
        to hear other people's opinions on that.
