...
***** DONE Section 3.2 (code 2), may warrant more guidance on when this is
      ...
      + So this confuses me...  Error 1 (unsupported DNSKEY alg) could
        be included in any message where the DNSKEY algorithm (say 1
        RSA/MD5) isn't supported. A servfail would be returned with
        EDE-1 as well.
...
***** TODO Section 3.6, code 6 (indeterminate answer) needs clarification,
