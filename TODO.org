...
*** TODO Paul Hoffman previously

***** TODO Proposal: add the following sentence to the end of the abstract:
      "Extended error information does not change the processing of RCODEs."

  
***** TODO Proposal: add to the end of the Introduction: Applications MUST NOT
